...
using VS2019.GlowWindow.Tools.Interop;

namespace VS2019.GlowWindow.Data
{
    internal class GlowEdge : HwndWrapper
    {
        private const string GlowEdgeClassName = "GlowEdge";
        ...
        private readonly Controls.GlowWindow _targetWindow;
        ...
        internal GlowEdge(Controls.GlowWindow owner, Dock orientation)
        {
